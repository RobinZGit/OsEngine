...
REM Headless by default: enabled logics keep trading if Angular is closed (API window must stay open).
if "%TRADE_RUNNER_REQUIRE_UI%"=="" set "TRADE_RUNNER_REQUIRE_UI=0"

...
• Стоп-лосс / тейк-профит — в списке типов видны все варианты; недоступны для выбора (серые): SL «портфель с обновлением», любые TP по всему портфелю логики. Доступны: SL security / security_resume / security_inversion / portfolio; TP только по бумаге. Для «инверсия при повторной просадке» активна колонка «% инверсии»: сначала просадка ≥ Значение → только shadow; доп. просадка shadow ≥ % инверсии → боевая инверсия сигналов; ошибочный ход ≥ Значение → снова shadow; восстановление к пику → обычная логика. Уже сохранённые недоступные типы остаются в таблице.

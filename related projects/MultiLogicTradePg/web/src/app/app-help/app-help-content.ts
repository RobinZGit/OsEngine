...
• Стоп-лосс / тейк-профит — по бумаге, портфелю, security_resume, security_inversion, portfolio_resume (пауза портфеля → shadow до восстановления; warmup не применяется) (% или ATR).

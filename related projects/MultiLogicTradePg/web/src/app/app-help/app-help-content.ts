...
• Параметры — таймфрейм, % позиции, лимит позиций, балансы, комиссия, FIFO/AVERAGE, базовая ставка рейтинга, lookback, инверсия, прогрев (warmup_pretest), денежный фонд (cash_fund_code / cash_fund_threshold: на каждой закрытой свече TF, если свободный кэш > порога — BUY TMON/LQDT/SBMM; в тесте и в бою; fake — sim-сделка), сброс баланса.

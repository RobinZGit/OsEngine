...
• My Projects — хаб всех опубликованных проектов: https://robinzgit.github.io/OsEngine/my-projects.html (Crypt, MultiLogic, FINRESP, UN Calculator, Диетолог, Календарь, MacroRithm…)
...
• Отдельный тип SL по бумаге: просадка ≥ % → shadow; возврат shadow к нулю → toggle real_trading_inverted на этой бумаге.
• Галочка в параметрах — на всю логику сразу; стоп — локально по бумаге.

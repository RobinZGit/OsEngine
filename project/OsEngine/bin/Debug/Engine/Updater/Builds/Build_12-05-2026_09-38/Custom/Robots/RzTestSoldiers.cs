...
{
[Bot("RzTestSoldiers")]
public class RzTestSoldiers : BotPanel
{
...
public RzTestSoldiers(string name, StartProgram startProgram) : base(name, startProgram)
{
// non trade periods
...
DeleteEvent += RzTestSoldiers_DeleteEvent;
}
...
// Delete save file
private void RzTestSoldiers_DeleteEvent()
{
try
{
...
if (( ((_buySellMode.ValueString == "OnlyBuy") || (_buySellMode.ValueString == "BuyAndSell") ) &&
    candles[candles.Count - 3].Open < candles[candles.Count - 3].Close

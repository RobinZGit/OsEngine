...
{
[Bot("FuturesStart1RzTestFutures")]
public class FuturesStart1RzTestFutures : BotPanel
{
BotTabSimple _base1;
...
public FuturesStart1RzTestFutures(string name, StartProgram startProgram) : base(name, startProgram)
{
// non trade periods

...
/*
rz скопировано и переделано под RSI
...
{
    [Bot("RzFuturesStartRsi")]
    public class RzFuturesStartRsi : BotPanel
    {
        BotTabSimple _base1;
        ...
        public RzFuturesStartRsi(string name, StartProgram startProgram) : base(name, startProgram)
        {
            // non trade periods
